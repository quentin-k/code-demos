...
section .data
	   ...
	   neg_num	dq	-12	; to show the sign extenstion
...
main:
	   ...
	   ; MULtiply, why "i" infront of mul though?
	   mov	rax, [number1]
	   ...
	   ; DIVide, again, what's with the "i"?
	   mov	rax, [number1]
	   mov	rdx, 0			; rdx needs to be 0 before idiv
	   idiv	qword [number2]	; divide rax by number, modulo in rdx
	   mov	[resulti], rax
